...
const SoftSkills = () => {
   return (
      <div>
         ...
         <ul>
            <li>Communication and collaboration with your other colleagues</li>
            <li>Time management skills</li>
            <li>Interpersonal communcation and networking skills</li>
            <li>Skillful use of social media</li>
            <li>Empathy</li>
